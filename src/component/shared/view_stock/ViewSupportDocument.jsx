...
// const ViewSupportDocument = ({ attachments }) => {
...
//               {
//                 FILE_NAME:
//                   "blob:http://localhost:5577/c831dacd-f338-4d92-be12-43de76398247",
//                 ext: ".png",
//               },
//               {
//                 FILE_NAME:
...
//               <div
//                 key={i}
//                 className="flex justify-between items-center bg-white shadow-sm p-2 border rounded-lg"
//               >
//                 {data?.FILE_NAME ? (
//                   <div className="group w-full">
//                     {data?.ext?.includes(".jpg") ||
//                     data?.ext?.includes(".jpeg") ||
//                     data?.ext?.includes(".png") ||
//                     data?.ext?.includes(".PNG") ? (
...
//                         </div>
//                       </div>
//                     ) : data?.ext?.includes(".pdf") ||
//                       data?.ext?.includes("doc") ||
//                       data?.ext?.includes("csv") ||
//                       data?.ext?.includes("zip") ||
//                       data?.ext?.includes("docx") ? (
...
// export default ViewSupportDocument;
...
const VeiwSupportDocument = ({ attachments }) => {
  const [imageModalOpen, setImageModalOpen] = useState({
    status: false,
    file: null,
  });
  ...
  const fileName = useMemo(() => {
    ...
    // const isAdvance = Object.entries(data).some(([key]) => key === "PRINCIPAL" || key === "MONTHLY_REPAYMENT")
    return "Attachment";
  }, []);
        ...
        <div className=" flex gap-4 flex-wrap">
          {attachments?.length > 0 ? (
            [
              ...attachments,
              {
                FILE_NAME: `https:/hr.ncaa.gov.ng/old_hr/pub/attachments/1738752837.pdf`,
              },
            ]?.map((data, i) => (
              <div
                key={i}
              ...
              >
                {data?.FILE_NAME ? (
                  <div className="group w-full">
                    ...
                    data?.FILE_NAME?.includes(".PNG") ? (
                      <div className="relative border hover:border-gray-400 rounded-lg shadow-sm">
                        <img
                          alt="Image"
                          height="100"
                          width="100"
...
export default VeiwSupportDocument;
